...
void cargar (Persona arreglo[], int & dl){  // Funcion para inscribir personas
    ...
    getline (cin>>ws,arreglo[dl].NombreApellido);
    ...
    arreglo[dl].Sexo=sexo;

    cout << "Ingrese el dia de nacimiento: ";
    cin >> dia; 
    arreglo[dl].Cumpleaños.dia=dia;
    

    cout << "Ingrese el mes de nacimiento: ";
    cin >> mes; 
    arreglo[dl].Cumpleaños.mes=mes;

    cout << "Ingrese el año de nacimiento: ";
    cin >> año;

    arreglo[dl].Cumpleaños.año=año;
    dl++;
}
...
void personasPorAño(Persona arreglo[], int dl){ // Funcion para contar personas inscriptas por año
    ...
    for (int i = 0; i < dl; i++)
    {
        if (arreglo[dl].Cumpleaños.año==num)
        {
            contador++;
        }
    }
    cout << "Cantidad de personas inscriptas nacidas en el año " << num << " son: "<< contador << endl;
}
